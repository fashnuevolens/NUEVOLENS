...
def start_action():
    ...
    process = subprocess.Popen(
        [r"C:\Users\pc\PycharmProjects\NUEVOLENS\root\Scripts\python.exe", "module_3_1.py"],
...
root = tk.Tk()
root.title("NUEVOLENS Surveillance System ADMIN")
...
stop_btn = tk.Button(root, text="STOP", fg="#380054", bg="hot pink", font=("Bauhaus 93", 14, "bold"), command=stop_action)
stop = b.create_window(800, 650,anchor="center", window=stop_btn)

title = tk.Label(root,text="NUEVOLENS SECURED SURVEILLANCE ADMIN",bg="#380054", fg="hot pink" , font= ("Bauhaus 93", 24, "bold"))
